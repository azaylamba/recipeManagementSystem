You have to design & build the backend for the application and the ability for the users to register, add recipes and view recipes.
...
https://github.com/azaylamba/recipeManagementSystem 
